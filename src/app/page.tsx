      ...
      <main className="flex min-h-screen w-full flex-col gap-6 p-4 sm:p-10 md:flex-row">
        ...
        <div className="flex h-fit w-full flex-col gap-3 md:w-1/2">
          ...
          <div className="mt-3 flex h-fit w-full flex-col rounded-xl bg-gray-100 bg-opacity-70 p-4">
            ...
            <span className="text-sm text-gray-500">This key should be used when calling our API, to authorize your requests. It needs to be kept secret.</span>
          ...
          <div className="mt-3 flex h-fit w-full flex-col rounded-xl bg-gray-100 bg-opacity-70 p-4">
            <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
              ...
              <span className="text-sm text-gray-500">{quota.requestsUsed} / {quota.maxRequests} requests</span>
            </div>
